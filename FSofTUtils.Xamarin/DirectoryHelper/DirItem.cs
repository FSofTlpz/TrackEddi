...
namespace FSofTUtils.Xamarin.DirectoryHelper {
   ...
   class DirItem {
      ...
      public string InfoText {
         get {
            if (IsRoot) {
               string txt = string.Format("Root: {0} entfernbar, {1} emuliert, {2} GByte gesamt, {3} GByte frei",
               ...
               if (Subdirs >= 0 && Files >= 0)
                  txt += string.Format(", {0} Verzeichnis{1}, {2} Datei{3}",
                                       Subdirs,
                                       Subdirs != 1 ? "se" : "",
                                       Files,
                                       Files != 1 ? "en" : "");
               ...
               return txt + Timestamp.ToString("G");
            }
