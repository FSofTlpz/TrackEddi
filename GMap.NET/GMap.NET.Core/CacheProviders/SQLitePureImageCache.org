    ...
    public class SQLitePureImageCache : PureImageCache
    {
        ...
        public string CacheLocation
        {
            ...
            set
            {
                ...
                // make empty db
                {
                    ...
                    _connectionString = getConnectionString(_db);
                }
        ...
        public static bool CreateEmptyDB(string file)
        {
            ...
            try
            {
                ...
                {
                    cn.ConnectionString = getConnectionString(file);
                    cn.Open();
                    {
        ...
        public static bool ExportMapDataToDB(string sourceFile, string destFile)
        {
            ...
            try
            {
                ...
                if (ret)
                {
                    ...
                    {
                        cn1.ConnectionString = getConnectionString(sourceFile);
                        cn1.Open();
                        if (cn1.State == System.Data.ConnectionState.Open)
                        {
                            using (var cn2 = new SQLiteConnection())
                            {
                                cn2.ConnectionString = getConnectionString(sourceFile);
                                cn2.Open();
        ...
        static string getConnectionString(string file)
        {
#if !MONO
            return string.Format("Data Source=\"{0}\";FailIfMissing=False;Page Size=32768", file);
#else
#if Android
            // Keywords: https://docs.microsoft.com/de-de/dotnet/standard/data/sqlite/connection-strings
            Microsoft.Data.Sqlite.SqliteConnectionStringBuilder connectionString = new Microsoft.Data.Sqlite.SqliteConnectionStringBuilder()
            {
                DataSource = file,
...
#else
            return string.Format("Version=3,URI=file://{0},FailIfMissing=False,Page Size=32768", file);
#endif
#endif
        }
